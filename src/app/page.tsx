      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 pt-12 md:pt-16 pb-8 w-full relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="font-mono text-xs font-bold uppercase tracking-wider text-[#4A4A4A]">
              CODE NOIR // 2026 EDITION
            </span>
          </div>

          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase tracking-tight text-[#171717] leading-[0.95] mb-4">
            CODE NOIR
          </h1>
          ...
          <p className="font-mono text-sm sm:text-base md:text-lg text-[#171717] font-bold max-w-2xl mx-auto mb-4 leading-relaxed">
            Upload a project. Follow the evidence. Learn how the pieces actually work.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-3">
            <div className="font-mono text-xs md:text-sm text-[#171717] font-black tracking-wide bg-[#8ED8B0] border-2 border-[#171717] py-1.5 px-4 inline-block shadow-[3px_3px_0px_#171717]">
              &quot;Don&apos;t worry. We won&apos;t judge your code. Much.&quot;
            </div>
            <ReplayGuideButton className="bg-white border-2 border-[#171717] px-3 py-1.5 shadow-[2px_2px_0px_#171717] text-[#171717] no-underline font-black hover:bg-[#F5F1E8]" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
          {/* Card 1: AST Graph */}
          <div className="bg-white border-3 border-[#171717] p-6 shadow-[6px_6px_0px_#171717] relative hover:-translate-y-1 transition-all">
            <div className="w-8 h-8 bg-[#3157D5] text-white border-2 border-[#171717] flex items-center justify-center mb-4 shadow-[2px_2px_0px_#171717]">
              <Cpu className="w-4 h-4" />
            </div>
            <div className="font-mono text-xs font-black text-[#3157D5] mb-1">01 // RECONSTRUCTION</div>
            <h3 className="text-lg font-mono font-black uppercase text-[#171717] mb-2">
          ...
          <div className="bg-white border-3 border-[#171717] p-6 shadow-[6px_6px_0px_#171717] relative hover:-translate-y-1 transition-all">
            <div className="w-8 h-8 bg-[#F4C542] text-[#171717] border-2 border-[#171717] flex items-center justify-center mb-4 shadow-[2px_2px_0px_#171717]">
              <Terminal className="w-4 h-4" />
            </div>
            <div className="font-mono text-xs font-black text-[#171717] mb-1">02 // INTERROGATION</div>
            <h3 className="text-lg font-mono font-black uppercase text-[#171717] mb-2">
          ...
          <div className="bg-white border-3 border-[#171717] p-6 shadow-[6px_6px_0px_#171717] relative hover:-translate-y-1 transition-all">
            <div className="w-8 h-8 bg-[#B8A7E8] text-[#171717] border-2 border-[#171717] flex items-center justify-center mb-4 shadow-[2px_2px_0px_#171717]">
      ...
      <footer className="border-t-4 border-[#171717] bg-[#171717] text-white py-6 px-4 md:px-8 mt-16 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-400">// CODEBASE INVESTIGATION 2026</span>
          </div>
          <div className="flex items-center gap-4">
            <ReplayGuideButton className="text-zinc-300 hover:text-white" />
            <span className="text-zinc-500">•</span>
            <span className="text-zinc-400">
              DETERMINISTIC CODE INTELLIGENCE • ZERO REPOSITORY HALLUCINATION
            </span>
          </div>
        </div>
      </footer>
